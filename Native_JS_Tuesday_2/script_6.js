const students = [
  ...
  const sortedByName_2 = deepCopyStudents.sort((a, b) => a.name >= b.name ? 1 : -1);
  const sortedByName_3 = students.sort((a, b)=> a.name.localeCompare(b.name));
  
  console.log(sortedByName_2);
